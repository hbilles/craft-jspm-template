...
$resolutions   = array(2000, 1280, 1024, 800, 480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "images/cache"; // where to store the generated re-sized images. This folder must be writable.
